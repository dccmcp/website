...
export const metadata: Metadata = {
  title: "MCP Integrations — Blender, Rhino, QGIS & CAD",
  description:
    "Every DCCMCP integration in one place: MCP servers for Blender, Maya, Houdini, 3ds Max, Rhino, ZBrush, Photoshop, FreeCAD and QGIS.",
